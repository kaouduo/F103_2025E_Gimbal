...
/**
 * @brief 姿态解算初始化，通过加速度计和磁力计进行初始对齐
 * @param ax,ay,az 加速度计三轴数据
 * @param mx,my,mz 磁力计三轴数据
 */
...
/**
 * @brief Mahony算法更新函数(仅IMU，不包含磁力计)
 * @param gx,gy,gz 陀螺仪三轴数据
 * @param ax,ay,az 加速度计三轴数据
 */
...
/**
 * @brief 从四元数计算欧拉角(Roll, Pitch, Yaw)
 * */
